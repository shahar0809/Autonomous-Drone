...
public:
    ...
    void interprate()
    {
        ...
        {
            cout << " Inexistent camera calibration mode: " << patternToUse << endl;
            goodInput = false;
        }
        atImageList = 0;
...
Calibration user_calibrate_camera(const std::string& path)
{
    help();
    Settings s;
    const string& inputSettingsFile = path;
    ...
    catch (...)
    {
        ...
        for(int i = 0;;++i)
        {
            ...
            if ( found)                // If done with success,
            {
                ...
                cv::imshow("cal", view); // Show our image inside the created window.
